...
from calculator.command.commands.add import AddCommand
from calculator.command.commands.subtract import SubtractCommand
from calculator.command.commands.multiply import MultiplyCommand
from calculator.command.commands.divide import DivideCommand
